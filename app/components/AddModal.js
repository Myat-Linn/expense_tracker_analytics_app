        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="modal-row">
            <div className="form-group">
              ...
              <input id="tx-amount" className="input" type="number" placeholder="0.00" step="0.01" min="0" value={amount} onChange={e => setAmount(e.target.value)} required />
            </div>
            <div className="form-group">
              <label className="label" htmlFor="tx-date">Date</label>
              <input id="tx-date" className="input" type="date" value={date} onChange={e => setDate(e.target.value)} required />
            </div>
          </div>

          <div className="form-group">
            <label className="label" htmlFor="tx-category">Category</label>
            <select id="tx-category" className="select" value={category} onChange={e => setCategory(e.target.value)} required>
          ...
          <div className="form-group">
            ...
            <input id="tx-description" className="input" type="text" placeholder="e.g. Lunch at Subway" value={description} onChange={e => setDescription(e.target.value)} />
          </div>

          <div className="modal-actions">
            <button type="button" className="btn btn-ghost" onClick={onClose}>Cancel</button>
            <button type="submit" id="submit-transaction-btn" className={`btn ${type === 'income' ? 'btn-income' : 'btn-expense'}`}>
